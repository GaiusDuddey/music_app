...
import 'package:music_app/audio_info12.dart';
...
class Heroes extends StatefulWidget {
  ...
  @override
  State<Heroes> createState() => _HomeScreenState();
}

class _HomeScreenState extends State<Heroes> {
  ...
  Future initPlayer() async {
    player = AudioPlayer();
    path = AssetSource('audio/Heroes.mp3');
