...
import 'package:music_app/audio_info13.dart';
import 'package:music_app/utils/utils.dart';
import 'package:shake/shake.dart';

class Coffin extends StatefulWidget {
  const Coffin({super.key});

  @override
  State<Coffin> createState() => _HomeScreenState();
}

class _HomeScreenState extends State<Coffin> {
  ...
  Future initPlayer() async {
    player = AudioPlayer();
    path = AssetSource('audio/Coffin.mp3');
