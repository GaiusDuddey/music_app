...
import 'package:music_app/audio_info11.dart';
...
class Mic extends StatefulWidget {
  ...
  @override
  State<Mic> createState() => _HomeScreenState();
}

class _HomeScreenState extends State<Mic> {
  ...
  Future initPlayer() async {
    player = AudioPlayer();
    path = AssetSource('audio/Mic.mp3');
