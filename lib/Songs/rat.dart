...
import 'package:music_app/audio_info14.dart';
...
class Rat extends StatefulWidget {
  ...
  @override
  State<Rat> createState() => _HomeScreenState();
}

class _HomeScreenState extends State<Rat> {
  ...
  Future initPlayer() async {
    player = AudioPlayer();
    path = AssetSource('audio/Rat.mp3');
